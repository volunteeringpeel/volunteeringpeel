...
export default {
  ...
  events: [
    ...
    },
    {
      ...
      description: (
        <span>
          Come help out at the Scotiabank Toronto Waterfront Marathon! Volunteers will receive
          snacks and beverages, a volunteer tshirt, a community service hours letter, and a
          memorable volunteer experience!<br />
